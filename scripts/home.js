...
const home = {
  ...
  <main>
    <section class="content flex-sm-column fifties-border">
      ...
      <p>If you are here to learn a few things <a href="#!/about">about me</a>, why don't you check out my <a href="Jacquelyn_Aimee_Olson_Resume .pdf">resumé</a> and <a href="https://github.com/devjaq">portfolio</a>?</p>
    </section>
  </main>
  `,
  controller: () => {
